...
/**
 * REST controller for managing {@link com.wedevzone.digiparc.domain.Formation}.
 */
@RestController
@RequestMapping("/api")
public class FormationResource {
    ...
    public List<FormationDTO> getAllFormations(@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
