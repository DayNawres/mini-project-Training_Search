...
const requireRestSample: RestInscription = {
  ...
  dateValiditeDebut: sampleWithRequiredData.dateValiditeDebut?.format(DATE_FORMAT),
  dateValiditeFin: sampleWithRequiredData.dateValiditeFin?.format(DATE_FORMAT),
};
